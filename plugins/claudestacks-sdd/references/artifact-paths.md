...
Canonical location and naming for every artifact the claudestacks-sdd workflow reads or
...
key="${base}-${hash8}"   # e.g. claudestacks-3f9a2c1b
```
...
hook, the `/claudestacks-sdd:setup` command, and lazy-create inside the writing skills
