#!/bin/sh
# claudestacks SessionStart preflight.
#
...
echo 'Reminder: run /claudestacks:snapshot-load for the current git branch to rehydrate relevant project memory before starting work.'
