...
//! [`crate::transport::Transport`] contract fixed to the HTTP associated types.
...
//! impl in `crate::transport::http_transport` makes the generated mock an
//! `HttpTransport` automatically.

use bytes::Bytes;
use http::{Request, Response};

use crate::transport::{BodyStream, Transport, TransportError};

mockall::mock! {
    /// Mock implementation of [`crate::transport::Transport`] (HTTP types) for tests.
    ///
