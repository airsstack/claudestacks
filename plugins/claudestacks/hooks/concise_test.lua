...
--
--   airsl test --allow-read / --allow-write /tmp --allow-exec git plugins/claudestacks/hooks
...
return {
  a_bare_slash_command_selects_the_default_level = function()
    ...
    assert(concise.classify("/claudestacks:concise") == concise.DEFAULT_LEVEL)
  end,

  a_slash_command_with_a_level_selects_it = function()
    assert(concise.classify("/concise ultra") == "ultra")
    assert(concise.classify("/claudestacks:concise lite") == "lite")
  end,
