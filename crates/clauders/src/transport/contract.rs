...
//!
//! Names no HTTP concept. The HTTP specialization is [`crate::transport::HttpTransport`];
...
/// associated types to the `http` crate types; see [`crate::transport::HttpTransport`].
