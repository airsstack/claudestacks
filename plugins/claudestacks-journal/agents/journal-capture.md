...
description: >
  Isolated session-story writer for the claudestacks-journal vault. Reads the
...
You write ONE session story into the claudestacks-journal vault, then stop. You
